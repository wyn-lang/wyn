...
HASHMAP_RUNTIME_SRC = $(RUNTIME_DIR)/hashmap.c
HASHMAP_RUNTIME_OBJ = $(BUILD_DIR)/hashmap_runtime.o
...
.PHONY: runtime
runtime: $(BUILD_DIR) $(SPAWN_RUNTIME_OBJ) $(ARRAY_RUNTIME_OBJ) $(BUILTINS_RUNTIME_OBJ) $(CHANNELS_RUNTIME_OBJ) $(TASK_RUNTIME_OBJ) $(HASHMAP_RUNTIME_OBJ)
...
$(HASHMAP_RUNTIME_OBJ): $(HASHMAP_RUNTIME_SRC)
	$(CC) $(CFLAGS) -c -o $@ $<
