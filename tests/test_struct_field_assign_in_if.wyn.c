...
void Node_cleanup(Node* obj) {
}

/* Generating 0 methods */
static const int NodeType_Int = 1;
static const int NodeType_String = 2;

// Lambda functions (defined before use)
int test_field_assign();
int wyn_main();

int test_field_assign() {
    Node node = *(Node*)wyn_arc_new(sizeof(Node), &(Node){.node_type = 0, .value = ""})->data;
    if (true) {
