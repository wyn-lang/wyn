...
int wyn_year();
int wyn_cpu_count();
int json_parse_int(int s);
int crypto_checksum(int data);
int http_status_ok();
int http_is_success(int status);
int db_is_connected(int state);
int db_count_results(int rows);
int wyn_main();
...
int wyn_main() {
    int math_test = (wyn_abs((0 - 5)) + wyn_max(10, 20));
    ;
