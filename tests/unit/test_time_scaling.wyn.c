...
int wyn_main() {
    __auto_type y1 = is_leap_year(2000);
    ;
    __auto_type y2 = is_leap_year(2004);
    ;
    __auto_type y3 = is_leap_year(2008);
    ;
    __auto_type y4 = is_leap_year(2012);
    ;
    __auto_type y5 = is_leap_year(2016);
    ;
    __auto_type y6 = is_leap_year(2020);
    ;
    __auto_type y7 = is_leap_year(2024);
    ;
    __auto_type y8 = is_leap_year(2001);
    ;
    __auto_type y9 = is_leap_year(2002);
    ;
    __auto_type y10 = is_leap_year(2003);
    ;
    __auto_type m1 = days_in_month(1);
    ;
    __auto_type m2 = days_in_month(2);
    ;
    __auto_type m3 = days_in_month(3);
    ;
    __auto_type m4 = days_in_month(4);
    ;
    __auto_type m5 = days_in_month(5);
    ;
    __auto_type m6 = days_in_month(6);
    ;
    __auto_type m7 = days_in_month(7);
    ;
    __auto_type m8 = days_in_month(8);
    ;
    __auto_type m9 = days_in_month(9);
    ;
    __auto_type m10 = days_in_month(10);
    ;
    __auto_type m11 = days_in_month(11);
    ;
    __auto_type m12 = days_in_month(12);
    ;
    return (((((((((((((((((((((y1 + y2) + y3) + y4) + y5) + y6) + y7) + y8) + y9) + y10) + m1) + m2) + m3) + m4) + m5) + m6) + m7) + m8) + m9) + m10) + m11) + m12);
}
